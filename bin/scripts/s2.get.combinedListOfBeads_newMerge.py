...
#          JING Zehua (jingzehua@genomics.cn)
#
...
#
#          2021-06-29 (v1.4) Added tarjan method for combination, which perform more careful combination
#
########
...
parser = argparse.ArgumentParser(description="get.combinedListOfBeads.py")
...
parser.add_argument("--simi_thres", type=float, default=1,
                    help="similarity should be greater than simi_thres")
